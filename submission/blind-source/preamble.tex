...
% Load the freely licensed fonts included with this source bundle by relative
% filename so arXiv's XeLaTeX build reproduces the submitted typography.
\setmainfont{EBGaramond-Regular.ttf}[
  Numbers=OldStyle,
  Ligatures=TeX,
  BoldFont={EBGaramond-Regular.ttf},
...
\setmonofont{Inconsolata-Regular.ttf}[
  BoldFont={Inconsolata-Regular.ttf},
